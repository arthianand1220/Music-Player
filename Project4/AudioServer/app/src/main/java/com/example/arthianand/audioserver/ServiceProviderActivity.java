package com.example.arthianand.audioserver;
    ...
    public IBinder onBind(Intent intent) {
        ...
        return new CommonInterface.Stub() {
            public void playservice(int tracknum) {
                ...
                //calls stop to make sure that 2 songs do not played at the exact time
                ...
                if(mPlayer==null) {
                    ...
                    if (mPlayer.isPlaying()) {
                        ...
                        mPlayer.start();
                        Log.d("arthi", "pause/play called");
                    } else {
                        mPlayer.start();
                        Log.d("arthi", "play called");
                    }
